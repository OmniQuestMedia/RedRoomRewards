# COPILOT-REINDOCTRINATION-LOCAL — RedRoomRewards
...
**Role:** Loyalty & compliance SaaS engine; will integrate Whisper voice-twin activity as first-class loyalty event source
**Status:** Active — referenced as 'stabilized' lint config in Cyrano WORK-ORDER

## PRIORITY DIRECTIVES IN THIS REPO'S QUEUE

No directives queued via Cowork orchestrator yet. Whisper-integration directives pending — wait for Cyrano API contract to be published in CyranoEngines.

## REPO-SPECIFIC NOTES

OQMI Infrastructure and Security Policy is referenced as Sovereign Policy in this repo's README. Strong policy compliance posture.
